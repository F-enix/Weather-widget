  ...
  <div id="app" :style="backgroundPos()">
    <main>
      ...
      <div class="day-selector">
        <Weekmenu @toggle="toggleDay" :forecast="forecast" :dateBuilder="dateBuilder" :f="f"/>        
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      api_url: 'https://api.openweathermap.org/data/2.5/onecall?lat=40.5873&lon=22.9482&exclude=minutely,hourly,alerts&units=metric',
      forecast: {},
      weather_icon: '',
      info_pressure: '',
      info_wind_deg: '',
  ...
  methods: {
    async fetchWeather() {
      fetch(`${this.api_url}&appid=${this.api_key}`)
          .then(response => {
